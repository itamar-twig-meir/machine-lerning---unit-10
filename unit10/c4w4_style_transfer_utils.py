...
class CONFIG:
    ...
    PATH = r'drive/My Drive/Deep Learning/course_materials/Neural Style Transfer/'
    VGG_MODEL = PATH+'pretrained-model/imagenet-vgg-verydeep-19.mat' # Pick the VGG 19-layer model by from the paper "Very Deep Convolutional Networks for Large-Scale Image Recognition".
